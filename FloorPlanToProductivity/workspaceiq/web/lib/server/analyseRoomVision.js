...
export const analyseRoomPrompt = [
  ...
  "Allowed type values: desk, l_shaped_desk, meeting_table, chair, armchair, table, filing_cabinet, whiteboard, plant, trashcan, toilet, sink, shower.",
  ...
  "Use armchair for lounge chairs, sofa chairs, cushioned chairs, or softer waiting-area seating.",
  ...
  "For furniture, explicitly detect existing desks, L-shaped desks, meeting tables with chairs, individual chairs, office chairs, task chairs, lounge chairs, armchairs, tables, file cabinets, whiteboards, plants, potted plants, trashcans, toilets, sinks, showers, and similar office or bathroom objects when visible.",
