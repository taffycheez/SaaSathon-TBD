...
import { normalizeAnalysisResult } from "@/lib/server/analyseRoomHelpers";
...
export const analyseRoomPrompt = [
  ...
  "Allowed type values: desk, l_shaped_desk, meeting_table, chair, armchair, couch, table, filing_cabinet, whiteboard, plant, trashcan, toilet, sink, shower, fridge, kitchenette.",
  "Use chair for standard chairs, office chairs, task chairs, desk chairs, rolling chairs, visitor chairs, seats, or chair symbols near workstations.",
  "Use armchair for lounge chairs, sofa chairs, cushioned chairs, or softer single-seat waiting-area seating.",
  "Use couch for sofas, couches, two-seat sofas, three-seat sofas, or other multi-seat soft seating.",
  ...
  "Do not return a generic equipment object. Skip printers, monitors, laptops, keyboards, or small electronics unless they clearly belong to another allowed furniture type.",
  ...
  "For furniture, explicitly detect existing desks, L-shaped desks, meeting tables with chairs, individual chairs, office chairs, task chairs, lounge chairs, armchairs, couches, tables, file cabinets, whiteboards, plants, potted plants, trashcans, toilets, sinks, showers, fridges, kitchenettes, and similar office, kitchen, or bathroom objects when visible.",
