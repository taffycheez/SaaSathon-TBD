...
- Affiliate product panel

### Preferable
- AI rearrangement suggestions (compare/toggle different arrangements)
- Save a wishlist
- Wall colour & texture swap
- Time-of-day slider with lighting simulation

### Maybe if time
- Add in Pinterest inspo 
- Augmented reality (overlay on phone's camera view rather than on 3D model)